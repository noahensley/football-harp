...
def read_sensor():
    """Connects to a BMP280 sensor and reads
    ...
    bmp280_output.append(str(round(bmp280.temperature),1))
    bmp280_output.append(str(round(bmp280.pressure / 1000),2))
    bmp280_output.append(str(round(bmp280.altitude),0))
